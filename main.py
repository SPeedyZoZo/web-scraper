...
# Modify parsing logic to iterate over all scraped contents
...
# Add this in the Streamlit interface after parsing
if st.button("Export Results"):
    if 'parsed_result' in st.session_state:
        export_to_csv(st.session_state.parsed_result, "parsed_data.csv")
